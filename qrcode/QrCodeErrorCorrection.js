...
/**
 * QR Code Log Table for Galois Field 256
 */
QrCodeErrorCorrection.prototype.exp2intx = {
    0: 1,
    1: 2,
    2: 4,
    3: 8,
...
/**
 * QR Code Antilog Table for Galois Field 256
 */
QrCodeErrorCorrection.prototype.int2expx = {
    1: 0,
    2: 1,
    3: 25,
    4: 2,
...
QrCodeErrorCorrection.prototype.getCode = function (data, dataWordsCount, eccWordsCount) {
    ...
    var xgenpn = 'g(x)=α0x10 + α251x9 + α67x8 + α46x7 + α61x6 + α118x5 + α70x4 + α64x3 + α94x2 + α32x + α45';

    xgenpn = xgenpn.replace(/^[^=]+=/, '');
